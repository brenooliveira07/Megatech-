...
CREATE POLICY "managers_view_all_roles"
...
GRANT EXECUTE ON FUNCTION public.admin_set_user_status(uuid, public.user_status)
TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.admin_update_profile(uuid, text)
TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.touch_last_access()
TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.my_status()
TO authenticated;